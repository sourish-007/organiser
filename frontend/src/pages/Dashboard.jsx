...
const Dashboard = ({ activeSection, navigationTrigger, clearNavigationTrigger }) => {
    ...
    if (activeSection === 'essay' && essayPointerId) {
      ...
      setTimeout(() => {
        ...
        if (element) {
          ...
          element.classList.add('bg-zinc-100');
          setTimeout(() => {
            element.classList.remove('bg-zinc-100');
          }, 2000);
        }
      }, 500);
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-4">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-zinc-800 dark:text-zinc-100">Essay Pointers</h1>
          </div>
          {isAddingEssay ? (
            <button
              onClick={() => setIsAddingEssay(false)}
              className="rounded bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-700 px-4 py-2 text-sm font-medium text-zinc-800 dark:text-zinc-200 transition"
            >
              Cancel
            </button>
          ) : (
            <button
              ...
              className="flex items-center gap-1.5 rounded bg-zinc-900 dark:bg-zinc-100 px-4 py-2 text-sm font-semibold text-zinc-50 dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition"
            >
        ...
        {isAddingEssay && (
          <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-5 space-y-4 max-w-xl shadow-sm">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3.5 py-2.5 text-base text-zinc-900 dark:text-zinc-100 outline-none placeholder-zinc-400 dark:placeholder-zinc-500 focus:border-zinc-500 dark:focus:border-zinc-600"
              />
            </div>
            <div className="space-y-1">
              <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
              ...
              <textarea
                ...
                className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3.5 py-2.5 text-base text-zinc-900 dark:text-zinc-100 outline-none placeholder-zinc-400 dark:placeholder-zinc-500 h-24 resize-none focus:border-zinc-500 dark:focus:border-zinc-600"
              />
            </div>
            <button
              onClick={handleAddEssayPointer}
              className="rounded bg-zinc-900 dark:bg-zinc-100 px-5 py-2.5 text-sm font-bold text-zinc-50 dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition"
            >
              Save Topic
            </button>
          </div>
        ...
        {loading && essayPointers.length === 0 ? (
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-20 w-full animate-pulse rounded bg-zinc-200/40"></div>
            ))}
          </div>
        ) : essayPointers.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-zinc-300 rounded-lg p-6">
            <Tag className="h-12 w-12 text-zinc-400 mb-3" />
            <h3 className="text-base font-bold text-zinc-700">No essay topics configured</h3>
            <p className="mt-1 text-sm text-zinc-500 max-w-sm leading-relaxed">
            ...
            {essayPointers.map((ep) => {
              ...
              return (
                <div
                  ...
                  className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-800 shadow-sm overflow-hidden transition"
                >
                  <div className="group flex items-start justify-between p-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition">
                    {isEditing ? (
                      <div className="space-y-3 w-full max-w-xl">
                        <input
                          ...
                          className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3 py-2 text-base text-zinc-900 dark:text-zinc-100 outline-none"
                        ...
                        <textarea
                          ...
                          className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3 py-2 text-sm text-zinc-800 dark:text-zinc-200 outline-none h-20 resize-none"
                          placeholder="Description"
                        />
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => handleUpdateEssayDetails(ep._id)}
                            className="flex items-center gap-1 rounded bg-zinc-800 dark:bg-zinc-100 hover:bg-zinc-700 dark:hover:bg-zinc-200 px-3 py-1.5 text-xs text-zinc-200 dark:text-zinc-900 font-bold"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 rounded bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-700 px-3 py-1.5 text-xs text-zinc-600 dark:text-zinc-300"
                          >
                            Cancel
                          </button>
                        </div>
                      ...
                      <>
                        <button
                          ...
                          className="flex-1 text-left select-none space-y-1.5"
                        >
                          <div className="flex items-center gap-2">
                            {isExpanded ? (
                            ...
                            <span className="rounded-full bg-zinc-100 dark:bg-zinc-700 px-2.5 py-0.5 text-xs text-zinc-500 dark:text-zinc-400 font-mono font-semibold">
                              {ep.points.length} points
                            </span>
                          </div>
                          {ep.description && (
                            <p className="pl-7 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                              {ep.description}
                            </p>
                          )}
                        </button>
                        ...
                        <div className="flex items-center gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition duration-150">
                          <button
                            ...
                            className="p-1.5 rounded hover:bg-zinc-100 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200"
                            title="Edit Topic"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 rounded hover:bg-zinc-100 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-red-650 dark:hover:text-red-400"
                            title="Delete Topic"
                          >
                  ...
                  {isExpanded && !isEditing && (
                    <div className="border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50/30 dark:bg-zinc-900/30 p-5 pl-12">
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {years.map((y) => (
            <div key={y._id} className="relative group flex items-center">
              {editingYearId === y._id ? (
                <div className="flex items-center gap-1 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded px-2.5 py-1">
                  <input
                    type="number"
                    ...
                    className="w-20 bg-transparent text-base text-zinc-900 dark:text-zinc-100 outline-none"
                    autoFocus
                  />
                  <button
                  ...
                  <button
                    ...
                    className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-650"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </div>
                ...
                <div className="flex items-center">
                  <button
                    ...
                    className={`flex items-center gap-1.5 rounded px-4 py-2 text-sm font-semibold transition ${
                      selectedYear?._id === y._id
                        ? 'bg-zinc-900 text-zinc-50 dark:bg-zinc-100 dark:text-zinc-900 shadow-md font-bold'
                  ...
                  <div className="absolute -top-1 -right-1 flex items-center gap-0.5 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition duration-150">
                    <button
                      onClick={() => {
                        setEditingYearId(y._id);
                        setEditingYearVal(y.year.toString());
                      }}
                      className="p-0.5 rounded bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200"
                    >
                      <Edit2 className="h-3.5 w-3.5" />
                    </button>
                    <button
                      onClick={() => handleDeleteYear(y._id)}
                      className="p-0.5 rounded bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-red-600"
                    >
          ...
          {isAddingYear ? (
            <div className="flex items-center gap-1 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded px-2.5 py-1">
              <input
                ...
                className="w-20 bg-transparent text-base text-zinc-900 dark:text-zinc-100 outline-none placeholder-zinc-400"
                autoFocus
              />
              <button
              ...
              <button
                ...
                className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-600"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded border border-dashed border-zinc-300 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-500 px-4 py-2 text-xs font-semibold text-zinc-500 dark:text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition"
            >
      ...
      {!selectedYear && (
        <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-zinc-300 rounded-lg p-6">
          <Calendar className="h-12 w-12 text-zinc-400 mb-3" />
          <h3 className="text-base font-bold text-zinc-700">No workspace years loaded</h3>
          <p className="mt-1 text-sm text-zinc-500 max-w-sm leading-relaxed">
      ...
      {selectedYear && loading && (
        <div className="space-y-4 py-8">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="h-12 w-full animate-pulse rounded bg-zinc-200/40"></div>
          ))}
        </div>
      )}
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3.5 text-left hover:bg-zinc-50 dark:hover:bg-zinc-700 transition select-none"
                >
                  <div className="flex items-center gap-2.5">
                    {isMonthExpanded ? (
                      <ChevronDown className="h-5 w-5 text-zinc-405 dark:text-zinc-400" />
                    ) : (
                      <ChevronRight className="h-5 w-5 text-zinc-405 dark:text-zinc-400" />
                    )}
                    <span className="text-base font-bold tracking-wide text-zinc-800 dark:text-zinc-100">
                      {m.month}
                    </span>
                    <span className="rounded-full bg-zinc-100 dark:bg-zinc-700 px-2.5 py-0.5 text-xs text-zinc-500 dark:text-zinc-400 font-mono font-semibold">
                ...
                {isMonthExpanded && (
                  <div className="border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50/30 dark:bg-zinc-900/30 p-4 space-y-4">
                    <div className="space-y-3">
                      {monthSubjects.map((sub) => {
                        ...
                        return (
                          <div
                            key={sub._id}
                            className="rounded border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 shadow-sm overflow-hidden"
                          >
                            <div className="group flex items-center justify-between px-3.5 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition">
                              {editingSubjectId === sub._id ? (
                                <div className="flex items-center gap-2 flex-1 max-w-sm">
                                  <input
                                    ...
                                    className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3 py-1.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none"
                                    autoFocus
                                  />
                                  <button
                                    onClick={() => handleUpdateSubject(sub._id)}
                                    className="text-emerald-600 dark:text-emerald-450 hover:text-emerald-500"
                                  >
                                    <Check className="h-4 w-4" />
                                  </button>
                                  <button
                                    onClick={() => setEditingSubjectId(null)}
                                    className="text-zinc-550 dark:text-zinc-500 hover:text-zinc-500 dark:hover:text-zinc-400"
                                  >
                                    <X className="h-4 w-4" />
                                  </button>
                                </div>
                                ...
                                <>
                                  ...
                                  <div className="flex items-center gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition duration-150">
                                    <button
                                      ...
                                      className="p-1 rounded hover:bg-zinc-100 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200"
                                      title="Edit Subject"
                                    >
                                    ...
                                    <button
                                      ...
                                      className="p-1 rounded hover:bg-zinc-100 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-400"
                            ...
                            {isSubjectExpanded && (
                              <div className="border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50/20 dark:bg-zinc-900/20 p-3 pl-6 space-y-3">
                                <div className="space-y-2.5">
                                  {subjectTopics.length === 0 ? (
                                    <p className="text-xs text-zinc-500 dark:text-zinc-400 italic py-1 pl-2">
                                      No topics added yet.
                                    </p>
                                  ) : (
                                    subjectTopics.map((topic) => {
                                      ...
                                      return (
                                        <div
                                          ...
                                          className="rounded border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 shadow-sm overflow-hidden transition-colors"
                                        >
                                          <div className="group flex items-center justify-between px-3.5 py-2.5 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition">
                                            {editingTopicId === topic._id ? (
                                              <div className="flex items-center gap-2 flex-1 max-w-sm">
                                                <input
                                                  ...
                                                  className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-2.5 py-1 text-sm text-zinc-900 dark:text-zinc-100 outline-none"
                                                  autoFocus
                                                />
                                                <button
                                              ...
                                              <>
                                                <button
                                                  ...
                                                  className="flex items-center gap-2.5 text-left flex-1 select-none"
                                                >
                                                  {isTopicExpanded ? (
                                                    <ChevronDown className="h-4 w-4 text-zinc-500 dark:text-zinc-400" />
                                                  ) : (
                                  ...
                                  {addingTopicSubjectId === sub._id ? (
                                    <div className="flex items-center gap-2 max-w-sm">
                                      <input
                                        ...
                                        className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded px-3 py-1.5 text-sm text-zinc-900 dark:text-zinc-100 outline-none placeholder-zinc-400 dark:placeholder-zinc-500"
                                        autoFocus
                                      />
                                      <button
                                        onClick={() => handleAddTopic(sub._id)}
                                        className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 p-1"
                                      >
                                        <Check className="h-4.5 w-4.5" />
                                      </button>
                                      <button
                                        onClick={() => setAddingTopicSubjectId(null)}
                                        className="text-zinc-500 dark:text-zinc-400 hover:text-zinc-500 dark:hover:text-zinc-300 p-1"
                                      >
                                    ...
                                    <button
                                      ...
                                      className="flex items-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 transition"
                                    >
                                      <Plus className="h-4 w-4" />
                                      Add Topic
                                    </button>
                      ...
                      {addingSubjectMonthId === m._id ? (
                        <div className="flex items-center gap-2 max-w-sm">
                          ...
                          <button
                            ...
                            className="text-zinc-500 dark:text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 p-1"
                          >
                            <X className="h-4.5 w-4.5" />
                          </button>
                        </div>
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 transition font-medium"
                        >
